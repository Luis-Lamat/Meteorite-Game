...
public class Planeta {
     ...
     * 
     */
    public Planeta(int iX, int iY ,Image imaImagen) {
        this.iX = iX;
        this.iY = iY;
     ...
     * 
     */
    public Planeta(int iX, int iY ,ImageIcon icoImagen) {
        this.iX = iX;
        this.iY = iY;
        imiIcono = icoImagen;
        this.iVelocidad = 1;    // default 1 en velocidad
     ...
     * arriba
     * 
     * Metodo que sube al planeta de acuerdo a la velocidad
     * 
     */
    public void arriba() {
     ...
     * abajo
     * 
     * Metodo que baja al planeta de acuerdo a la velocidad
     * 
     */
    public void abajo() {
        this.setY(this.getY() + iVelocidad);
     ...
     * derecha
     * 
     * Metodo que mueve a la derecha al planeta de acuerdo a la velocidad
     * 
     */
    public void derecha() {
     ...
     * izquierda
     * 
     * Metodo que mueve a la izquierda al planeta de acuerdo a la velocidad
     * 
     */
     ...
     * colisiona
     * 
     * Metodo para revisar si un objeto <code>Planeta</code> colisiona con otro
     * esto se logra con un objeto temporal de la clase <code>Rectangle</code>
     * 
     * @param aniObjeto es el objeto <code>Planeta</code> con el que se compara
     * @return  un valor true si esta colisionando y false si no
     * 
     */
    public boolean colisiona(Planeta pltParametro) {
        // creo un objeto rectangulo a partir de este objeto Planeta
        Rectangle recObjeto = new Rectangle(this.getX(),this.getY(),
                this.getAncho(), this.getAlto());
        
        // creo un objeto rectangulo a partir del objeto Planeta parametro
        Rectangle recParametro = new Rectangle(pltParametro.getX(),
                pltParametro.getY(), pltParametro.getAncho(),
                pltParametro.getAlto());
     ...
     * colisiona
     * 
     * Metodo para revisar si un objeto <code>Planeta</code> colisiona con una
